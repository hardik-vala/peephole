 ...
 * Benchmark #6 test.
 *
 * @precondition Benchmark #6 has been run and the output saved to file.
 */
public class Benchmark6Test {

    /** Path to Benchmark #6 directory. */
    private static final String DIR_PATH = "bench06";
